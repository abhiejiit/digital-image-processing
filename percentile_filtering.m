...
percentile_filtered_image = ordfilt2(noisy_image, round(9*0.5), true(3));

subplot(2,3,3);
imshow(percentile_filtered_image);
title('Percentile Filtered Image');
...
subplot(2, 3, 6);
imhist(percentile_filtered_image);
